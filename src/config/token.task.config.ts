...
type SymbolType = 'BTC' | 'ETH' | 'USDC';

type SymbolConfigValueType = {
...
type SymbolConfigType = {
    [y in SymbolType]: SymbolConfigValueType
}

type TokenFaucetConfigType = {
    [x in NetworkType]: SymbolConfigType
}

const tokenTaskConfig: TokenFaucetConfigType = {
    'DEVNET': {
        'BTC': {
